...
function LandingTestimony() {
    return (
        <div className="h-screen w-screen flex flex-col items-center px-[70px] py-[50px] relative">
            ...
            <h1 className="font-bold text-primary text-[50px] mb-10">Testimoni Pengguna</h1>
            <p className="text-[#4F5665] text-xl mb-10">Sebuah cerita dan pengalaman pengguna SmartCarrier</p>
