      ...
      <div className="px-[90px]">
        ...
        <div className="h-full grid grid-cols-3 gap-5 mt-10">
          {internshipData.map((item, index) => (
            <div key={index}>
              <div className="rounded-xl flex-col bg-white overflow-hidden mb-5 p-6 flex gap-5">
                <div className="flex flex-row gap-5 ">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h1 className="text-xs text-textPrimary">
                      Digital Marketing
                    </h1>
                  </div>
                </div>
                <Link href={`internship/detail/${item.id}`}>
