              ...
              <div className="flex flex-col  justify-between gap-8 px-5 py-4 w-full">
                <div>
                  <div className="flex flex-col gap-2">
                    ...
                    <h1 className="text-primary font-bold text-2xl truncate hover:text-clip">
                      {item.title}
                    </h1>
                  </div>
              ...
              <div className="flex flex-col  justify-between gap-8 px-5 py-4 w-full">
                <div>
                  <div className="flex flex-col gap-2">
                    ...
                    <h1 className="text-premium font-bold text-2xl truncate hover:text-clip">
                      {item.title}
                    </h1>
                  </div>
                  <p className="text-textPrimary font-light h-[50px] text-xs  hover:text-clip truncate">
                ...
                <Link href={`/courses/detail/${item.id}`}>
                  <button className="bg-gradient-to-r from-premium via-yellow-200 to-yellow-300 w-2/3 py-3 text-white rounded-xl flex items-center font-semibold justify-center gap-2">
                    Premium
